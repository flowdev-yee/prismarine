...
class BossBar extends LitElement {
  ...
  setTitle (bar) {
    const title = bar._title ?? {}
    if (title.text) this.title = title.text
    else if (title.translate) this.title = translations[title.translate] || title.translate
    else this.title = 'Unknown Entity'
  }
